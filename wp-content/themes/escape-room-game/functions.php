...
// Sửa lỗi đường dẫn Preview bị sai
add_filter('preview_post_link', 'fix_preview_link_error');
function fix_preview_link_error($link)
{
	// Ép kiểu đường dẫn về dạng mặc định để tránh lỗi Rewrite Rule
	$args = array(
		'p' => get_the_ID(),
		'preview' => 'true'
	);
